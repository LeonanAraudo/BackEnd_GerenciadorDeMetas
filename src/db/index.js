...
const schema = __importStar(require("./schema")); // o arquivo la tem varios schemas aqui ele vai pegar todas as exportações de la e jogar dentro de uma variavel schema
