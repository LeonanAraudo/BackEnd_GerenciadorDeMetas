...
exports.goals = (0, pg_core_1.pgTable)('goals', {
    ...
    desiredWeeklyFrequency: (0, pg_core_1.integer)('desired_weekly_frequency').notNull(), // É a quantidade de metas
    createdAt: (0, pg_core_1.timestamp)('created_at', { withTimezone: true }) //esse timezone tem a ver com fuso horario do local
        .notNull()
